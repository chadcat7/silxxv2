    ...
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
          <a href="/" className="flex makebig items-center">
            <img src="/logo.png" className="h-8 me-3" alt="FlowBite Logo" />
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">SILICO</span>
          </a>
        </div>
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          ...
          <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
              <li className="mb-4">
                <a href="" className="hover:underline makebig">Instagram</a>
              </li>
              <li>
                <a href="" className="hover:underline makebig">Discord</a>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
              <li className="mb-4">
                <a href="#" className="hover:underline makebig">Register</a>
              </li>
              <li>
                <a href="/message" className="hover:underline makebig">Message</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="/" className="hover:underline makebig">Silico Battles™</a>. All Rights Reserved.
        </span>
        <div className="flex mt-4 sm:justify-center sm:mt-0">
          <a href="#" className="makebig text-gray-500 hover:text-gray-900 dark:hover:text-white">
          ...
          <a href="#" className="makebig text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
