        ...
        >
          {hoveredIndex === item.id && (
            <motion.div
              ...
              className="absolute -top-16 -left-1/2 translate-x-1/2 flex text-xs  items-center justify-center rounded-md bg-black z-50 shadow-xl px-4 py-2"
            >
              ...
              <div className="text-white text-xs ml-2">{item.designation}</div>
            </motion.div>
          )}
          <img
