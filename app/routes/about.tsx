...
export default function Team() {
  return <>
    <div className=" w-full flex flex-col justify-center ">
      <div className="w-full  h-screen flex flex-col justify-center items-center" style={{ background: "linear-gradient(to bottom right, #09090bcc, #09090bbb 60%, #09090b99), url('./homepage/header.png')", backgroundSize: "cover", clipPath: "polygon(0 0, 100% 0%, 100% 100%, 0% 100%)", backgroundPosition: "top center", }}>
        <div className="mb-2 my-2 backdrop-blur-3xl rounded-full bg-sky-900/10 py-2 px-12 border-[1px] border-amber-400/30">Celebrating Two Decades Of the Silio Battles!</div>
      ...
      <div className="py-20 flex p-16 justify-center items-center w-full">
        ...
        <div className="content flex h-full w-full flex-col items-center justify-between">
          ...
          <p className="font-light text-xl mt-4 w-full px-6 text-center md:p-0 md:w-1/2">The name of our club is a wordplay on the word "Souvenir" which means a momento or precious memory. And this what the club strives to be. A beautiful and enjoyable memory for core team, the volunteers and the participants.</p>
